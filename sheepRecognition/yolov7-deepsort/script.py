...
tracker = YOLOv7_DeepSORT(reID_model_path="./deep_sort/model_weights/mars-small128.pb", detector=detector, max_cosine_distance=0.7, nn_budget=10)
...
for _ in range(1):
    ...
    tracker.track_video(show_live = False, skip_frames = 0, count_objects = True, verbose=1)
